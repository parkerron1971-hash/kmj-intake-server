-- ministry benchmark values.
--
-- OWNED BY THE MINISTRY AGENT. One view per vertical exists for exactly
...
--                                     -- workspace_benchmarks/bands/ministry.py
...
CREATE OR REPLACE VIEW public.business_benchmark_values_ministry AS
...
ALTER VIEW public.business_benchmark_values_ministry SET (security_invoker = true);
GRANT SELECT ON public.business_benchmark_values_ministry TO authenticated, service_role;
