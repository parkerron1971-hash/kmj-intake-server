-- nonprofit benchmark values.
--
-- OWNED BY THE NONPROFIT AGENT. One view per vertical exists for exactly
...
--                                     -- workspace_benchmarks/bands/nonprofit.py
...
CREATE OR REPLACE VIEW public.business_benchmark_values_nonprofit AS
...
ALTER VIEW public.business_benchmark_values_nonprofit SET (security_invoker = true);
GRANT SELECT ON public.business_benchmark_values_nonprofit TO authenticated, service_role;
