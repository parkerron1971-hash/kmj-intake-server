...
def test_library_shape_and_uniqueness():
    ...
    # nondiscrimination statement, a mission narrative). 16 -> 17 the
    # same day: the §170(f)(8) donation acknowledgment, which a nonprofit
    # issues more often than all six of those together. Raising this is
