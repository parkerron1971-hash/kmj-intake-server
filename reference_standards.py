...
STANDARDS: Dict[str, str] = {
    "refined_luxury": (
        ...
        "generous negative space; a condensed impact face undermines the "
        "direction.\n"
        "- Accents lean desaturated and precious — champagne gold, deep "
        "forest, oxblood — spent on hairlines, numerals and one CTA; "
        "full-saturation neon fights the direction.\n"
        "- Craft shows in achievable materials: thin engraved rules, "
        "generous letterspacing, layered dark tones, consistent image "
        "treatment — nothing raw or glaring.\n"
