...
| File | What | Status |
|---|---|---|
| `supabase/APPLY-2026-09-23-link-wallet.sql` | Customer-owned encrypted Link OAuth sessions, callback-state lookup and fenced writes. | **PENDING. Apply this migration after merge**, before setting LINK_WALLET credentials. No live spending is enabled. See docs/LINK_WALLET.md. |
