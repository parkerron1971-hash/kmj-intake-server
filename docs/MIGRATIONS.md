...
| File | What | Status |
|---|---|---|
| Frontend `supabase/APPLY-2026-09-08-course-learning.sql`, then `APPLY-2026-09-08-academy-authoring.sql`, then `APPLY-2026-09-08-academy-school.sql` | Rich lessons, protected student submissions, atomic Chief course authoring, verified school access, course teachers and grading. | Production rollback rehearsal passed 2026-09-08. Apply in this order before deploying the Academy frontend; enable `ACADEMY_CLASSROOM_V2=on` only once the frontend is live. |
