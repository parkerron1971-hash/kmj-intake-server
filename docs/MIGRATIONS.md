...
| `supabase/APPLY-2026-09-08-image-studio.sql` | Private image gallery, generation reservations, publication deduplication and atomic post preparation. | Pending; apply by hand after backend merge, before frontend release. |
| `supabase/APPLY-2026-09-08-conversation-desk.sql` | Chief conversation metadata for saved Image Studio threads, with business-owner RLS. | Pending; apply with Image Studio migration. |
