...
| File | What | Status |
|---|---|---|
| `supabase/APPLY-2026-09-12-chief-computer.sql` | Chief errand/event foundation and service-only encrypted login vault. | **PENDING. Apply after merge.** Requires existing owner/member RLS helpers. No errand runner, endpoint, saved cards, or production key enabled by PR1. See `docs/CHIEF_COMPUTER.md`. |
