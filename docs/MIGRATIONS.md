...
| File | What | Status |
|---|---|---|
| `supabase/APPLY-2026-09-11-agent-coordination.sql` | Owner-configured bot profiles, scoped assignment inbox, atomic claims, revision guards and service-only access. | Deployment applies and verifies this before releasing the feature. |
